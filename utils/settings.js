const setting = [
	{
		setting: {
			...
			shop_name: "happyStore",
			address: "59 Station Rd, Purls Bridge, United Kingdom",
			company_name: "HtmlLover ltd",
			vat_number: "47589",
			post_code: "2030",
			contact: "019579034",
			email: "happyStore@gmail.com",
			website: "admin-happystore.netlify.app",
			default_currency: "€",
		...
		setting: {
			...
			home: {
				...
				quick_delivery_description: {
					en: "There are many products you will find in our shop, Choose your daily necessary product from our happyStore shop and get some special offers. See Our latest discounted products from here and get a special discount.",
					de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem happyStore-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
				},
				...
				daily_need_title: {
					en: "Get Your Daily Needs From Our happyStore Store",
					de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
				},
				daily_need_description: {
					en: "There are many products you will find in our shop, Choose your daily necessary product from our happyStore shop and get some special offers.",
					de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem happyStore-Shop und erhalten Sie einige Sonderangebote.",
				},
			...
			about_us: {
				...
				top_title: {
					en: "Welcome to our happyStore shop",
					de: "Willkommen in unserem happyStore-Shop",
				},
				top_description: {
			...
			contact_us: {
				...
				email_box_email: {
					en: "info@happyStore.com ",
					de: "info@happyStore.com",
				},
				email_box_text: {
			...
			faq: {
				...
				faq_one: {
					en: "How does the happyStore work?",
					de: "Wie funktioniert der happyStore?",
				},
				description_one: {
				...
				faq_five: {
					en: "What is happyStore EC2 auto scaling?",
					de: "Was ist die automatische Skalierung von happyStore EC2?",
				},
				description_five: {
					en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
				...
				faq_six: {
					en: "What are the benefits of using happyStore affliate?",
			...
			seo: {
				...
				meta_title:
					"happyStore - React Grocery & Organic Food Store e-commerce Template",
				meta_url: "https://admin-happystore.netlify.app/",
			},
		},
